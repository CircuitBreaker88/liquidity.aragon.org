const ENV_VARS = {
  ...
  SITE_DESCRIPTION: [process.env.SITE_DESCRIPTION, 'NMT Liqudity Rewards'],
  SITE_TITLE: [process.env.SITE_DESCRIPTION, 'NMT Liquidity Rewards'],
  SITE_URL: [process.env.SITE_URL, 'https://liquidity.nova.org/'],
}
